...
export const UserManagement = () => {
	...
	useEffect(() => {
		const filtered = users.filter(
			(user) =>
				...
				(user.username &&
					user.username.toLowerCase().includes(searchTerm.toLowerCase())), // Search by username too
		);
	...
	return (
		<div className="space-y-6 md:ps-4">
			<div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
				...
				<div className="relative">
					...
					<Input
						...
						className="text-sm md:text-base pl-10 w-64"
					/>
				</div>
			</div>
			...
			<Card className="md:border-0 md:bg-transparent md:shadow-none">
				...
				<CardContent className="p-4 md:px-2 md:py-0">
															...
															<AlertDialogContent>
																<AlertDialogHeader>
																	...
																	<AlertDialogDescription>
																		...
																		appointments, documents, and prescriptions.
					...
					<div className="space-y-4">
						...
						<div>
							...
							<Select
								...
								onValueChange={(value) =>
									setEditForm((prev) => ({ ...prev, concern: value }))
								}
							>
								<SelectTrigger>
