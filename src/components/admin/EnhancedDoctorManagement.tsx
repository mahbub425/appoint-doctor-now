...
export const DoctorManagement = () => {
	...
	return (
		<div className="space-y-2 md:ps-4">
			<div className="flex justify-between items-center">
				<h2 className="text-xl md:text-2xl font-bold">
					Doctor List{" "}
					<span className="text-muted-foreground">({doctors.length})</span>
				</h2>
				...
				<CardContent className="p-4 md:p-0">
					{doctors.length === 0 ? (
						...
						<Table>
							<TableHeader>
								<TableRow>
									<TableHead className="md:ps-0">Name</TableHead>
							...
							<TableBody>
								{doctors.map((doctor) => (
									<TableRow key={doctor.id}>
										<TableCell className="font-medium md:ps-0">
											{doctor.name}
										</TableCell>
										...
										<TableCell>
											<div className="flex items-center gap-2">
												...
												<Button
													...
													variant="outline"
													onClick={() =>
														navigator.clipboard.writeText(doctor.password_hash)
													}
												>
													Copy
												</Button>
										...
										<TableCell className="md:pe-0">
											<div className="flex gap-2">
												...
												<Button
													...
													onClick={() =>
														handleToggleActive(doctor.id, doctor.is_active)
													}
												>
													{doctor.is_active ? (
													...
													<AlertDialogContent>
														<AlertDialogHeader>
															...
															<AlertDialogDescription>
																...
																{doctor.name}? This will also delete all their
																schedules, appointments, and prescriptions. This
			...
			<Dialog
				open={showAddForm || !!editingDoctor}
				onOpenChange={() => {
					setShowAddForm(false);
					setEditingDoctor(null);
					resetForm();
						...
						<div className="grid grid-cols-2 gap-4">
							...
							<div>
								<Label htmlFor="doctor-password">
									Password{" "}
									{editingDoctor ? "(leave empty to keep current)" : "*"}
								</Label>
								<Input
									id="doctor-password"
									type="password"
