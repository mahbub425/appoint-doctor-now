...
export const ProfileManagement = () => {
	...
	return (
		<div className="space-y-6">
			<Card>
				<CardHeader>
					<CardTitle className="bg-secondary text-primary p-3 text-lg font-semibold">
						Personal Details
					</CardTitle>
				</CardHeader>
				<CardContent className="space-y-4">
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						...
						<div>
							...
							<p className="text-sm text-muted-foreground mt-1">
								{userProfile.pin ? userProfile.pin : 'N/A'}
							</p>
						</div>
						...
						<div>
							...
							<p className="text-sm text-muted-foreground mt-1">
								{userProfile.concern ? userProfile.concern : 'N/A'}
							</p>
						</div>
					...
					<Dialog>
						<DialogTrigger asChild>
							<Button className="mt-4 min-h-12 min-w-28">Edit Details</Button>
						</DialogTrigger>
						<DialogContent>
